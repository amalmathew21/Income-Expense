...
const handleToggleInput1 = (e) => {
  if (showConfirmPasswordToggle.textContent === "SHOW") {
    showConfirmPasswordToggle.textContent = "HIDE";
    confirmpasswordField.setAttribute("type", "text");
  } else {
    showConfirmPasswordToggle.textContent = "SHOW";
    confirmpasswordField.setAttribute("type", "confirmpassword");
  }
};

showConfirmPasswordToggle.addEventListener("click", handleToggleInput1);
